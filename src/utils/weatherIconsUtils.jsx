/* All possibles WeatherId from 'OpenWeatherMap' API */
...
export const getWeatherKeyword = (id) => {
    ...
    const index = aWeatherKeywordsValues.findIndex(
        array => array.find(value => value == id)
        );
    const keyword = Object.keys(weatherKeywords)[index]; 
    
    return (
        keyword ? Object.keys(weatherKeywords)[index] : "day-sunny"
    )
}
